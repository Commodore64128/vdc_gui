...
; ---------------------------------------------------------------
; __near__ struct _CHECKBOX * __near__ CreateCheckbox (__near__ struct Window *, __near__ unsigned char *, unsigned char, unsigned char, __near__ unsigned char *)
; ---------------------------------------------------------------
...
; ---------------------------------------------------------------
; void __near__ _renderCheckboxHandler (__near__ struct Control *)
; ---------------------------------------------------------------
...
L0032:	ldy     #$03
	...
	ldx     #$00
	lda     #$20
L008F:	jsr     _VDC_PetsciiToScreenCode
	jsr     _VDC_Poke
...
L0041:	dey
	...
	ldx     #$00
	lda     #$20
L0090:	jsr     _VDC_PetsciiToScreenCode
	jsr     _VDC_Poke
...
L008B:	bpl     L005B
	...
	lda     (sp),y
	ldx     #$00
L0091:	jsr     _VDC_PetsciiToScreenCode
	jsr     _VDC_Poke
	.dbg	line, "vdc_control_checkbox.c", 78
L005B:	ldy     #$0A
	jsr     ldaxysp
...
; ---------------------------------------------------------------
; void __near__ _checkBoxInputHandler (__near__ struct Control *, unsigned char)
; ---------------------------------------------------------------
